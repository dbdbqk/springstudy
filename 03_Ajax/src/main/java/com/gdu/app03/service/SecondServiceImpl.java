...
public class SecondServiceImpl implements ISecondService {
	...
	public ResponseEntity<BmiVO> execute1(HttpServletRequest request) {
		try {
			...
			BmiVO bmiVO = null;
			return new ResponseEntity<BmiVO>(bmiVO, HttpStatus.INTERNAL_SERVER_ERROR);	// HttpStatus가 500이므로 $.ajax의 error로 간다.
		}
	...
	public ResponseEntity<Map<String, Object>> execute2(BmiVO bmiVO) {
		...
		MultiValueMap<String, String> header = new HttpHeaders();	// 클래스 클래스의 인터페이스?
