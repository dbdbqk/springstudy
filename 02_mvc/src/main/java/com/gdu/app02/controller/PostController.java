...
public class PostController {
	...
	public String list(HttpServletRequest request, Model model) {	// name, age 파라미터가 있다.
		...
		// /WEB-INF/views/post/list.jsp로 foward 하겠다!
		return "post/list";
	}
	...
	public String detailMe(HttpServletRequest request,
		...
		// Redirect 경로까지 전달되는 속성 : Flash Attribute 속성이다 속성!!!!
		redirectAttributes.addFlashAttribute("name", name);	// addAttribute()가 아님을 주의하세요! 꼭 꼭 
