...
public class SecurityUtil {
	...
	// 인증코드 반환하기
	public String getRandomString(int count,  boolean letter, boolean numbers) {
		return RandomStringUtils.random(count, letter, numbers);
	}
	...
	/*
		...
		5. 32바이트 -> 16진수로 변환하면 64글자가 생성된다. (DB칼럼의 크기를 VARCHAR2(64 BYTE)로 설정한다.) 
